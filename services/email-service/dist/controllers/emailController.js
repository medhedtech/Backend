...
class EmailController {
    ...
    async getQueueStats(req, res) {
        try {
            const stats = await emailService_1.default.getQueueStats();
            res.status(200).json({
                success: true,
                data: stats
            });
    ...
    async sendWelcomeEmail(req, res) {
        try {
            ...
            const result = await emailService_1.default.sendWelcomeEmail(email, fullName, userData);
            res.status(200).json({
                success: true,
    ...
    async sendPasswordResetEmail(req, res) {
        try {
            ...
            const result = await emailService_1.default.sendPasswordResetEmail(email, name, resetToken);
            res.status(200).json({
                success: true,
    ...
    async sendVerificationEmail(req, res) {
        try {
            ...
            const result = await emailService_1.default.sendVerificationEmail(email, name, otp);
            res.status(200).json({
                success: true,
    ...
    async sendNotificationEmail(req, res) {
        try {
            ...
            const result = await emailService_1.default.sendNotificationEmail(email, subject, message, data);
            res.status(200).json({
                success: true,
